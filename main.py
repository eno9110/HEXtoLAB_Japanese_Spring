...
st.title('HEXtoLAB_Japanese_Spring')
...
# === CSVファイルに保存 ===
csv_filename = 'hex_to_lab_colors_Japanese_spring.csv'
df.to_csv(csv_filename, index=False)

# === CSVダウンロードボタン ===
st.write("### HEXカラーとL* a* b* 座標のCSV出力_Japanese_spring")
st.download_button(
    label="CSVをダウンロード",
...
# === Streamlitで3Dグラフ表示 ===
st.write("### L* a* b* 色空間 3D可視化_Japanese_spring")
st.plotly_chart(fig)
